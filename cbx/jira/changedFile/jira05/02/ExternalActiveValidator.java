...
//                                    errorId = "CustomizedErrorId";
//                                    final DynamicEntity fact = DynamicEntityModel.getFullEntity(ENTITY_NAME_FACT,
//                                            entity.getId());
//                                    final Collection<DynamicEntity> vendorFacts = fact.getEntityCollection(VENDOR_FACT);
//                                    for (final DynamicEntity vendorFact : vendorFacts) {
//                                        final DynamicEntity vendorEntity = DynamicEntityModel.getEntityHeaderById(
//                                                ENTITY_NAME_VENDOR, vendorFact.getString(VENDOR_ID));
//                                        if (StringUtils.equals(EntityConstants.DocStatus.INACTIVE,
//                                                vendorEntity.getString(EntityConstants.PTY_DOC_STATUS))) {
//                                            vendorCodeList.append("-" + vendorEntity.getString(VENDOR_CODE) + "\n");
//                                            result = Boolean.FALSE;
